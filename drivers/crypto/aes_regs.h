...
#define AES_CTRL_SHADOWED_REG_RESVAL 0x11fdu
...
#define AES_CTRL_SHADOWED_MODE_VALUE_AES_GCM 0x20
#define AES_CTRL_SHADOWED_MODE_VALUE_AES_NONE 0x3f
...
#define AES_CTRL_GCM_SHADOWED_REG_OFFSET 0x88
#define AES_CTRL_GCM_SHADOWED_REG_RESVAL 0x401u
#define AES_CTRL_GCM_SHADOWED_PHASE_MASK 0x3fu
#define AES_CTRL_GCM_SHADOWED_PHASE_OFFSET 0
#define AES_CTRL_GCM_SHADOWED_PHASE_FIELD \
  ((bitfield_field32_t) { .mask = AES_CTRL_GCM_SHADOWED_PHASE_MASK, .index = AES_CTRL_GCM_SHADOWED_PHASE_OFFSET })
#define AES_CTRL_GCM_SHADOWED_PHASE_VALUE_GCM_INIT 0x1
#define AES_CTRL_GCM_SHADOWED_PHASE_VALUE_GCM_RESTORE 0x2
#define AES_CTRL_GCM_SHADOWED_PHASE_VALUE_GCM_AAD 0x4
#define AES_CTRL_GCM_SHADOWED_PHASE_VALUE_GCM_TEXT 0x8
#define AES_CTRL_GCM_SHADOWED_PHASE_VALUE_GCM_SAVE 0x10
#define AES_CTRL_GCM_SHADOWED_PHASE_VALUE_GCM_TAG 0x20
#define AES_CTRL_GCM_SHADOWED_NUM_VALID_BYTES_MASK 0x1fu
#define AES_CTRL_GCM_SHADOWED_NUM_VALID_BYTES_OFFSET 6
#define AES_CTRL_GCM_SHADOWED_NUM_VALID_BYTES_FIELD \
  ((bitfield_field32_t) { .mask = AES_CTRL_GCM_SHADOWED_NUM_VALID_BYTES_MASK, .index = AES_CTRL_GCM_SHADOWED_NUM_VALID_BYTES_OFFSET })
